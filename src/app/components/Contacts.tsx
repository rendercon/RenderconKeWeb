      ...
      <div className="flex items-center mx-auto mb-10">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex items-center">
              ...
              >
                <IconWrapper icon={FaTwitter} className="text-white text-3xl hover:fill-current hover:text-[#eee712]" />
              </a>
            </div>
            
            <div className="flex items-center">
              <button onClick={handleEmailClick} className="hover:text-[#eee712] bg-transparent border-none p-0">
                <IconWrapper icon={FaEnvelope} className="text-white text-3xl hover:fill-current hover:text-[#eee712]" />
              </button>
            </div>
            ...
            <div className="flex items-center">
              <a 
                ...
                rel="noopener noreferrer"
              >
                <IconWrapper icon={FaLinkedin} className="text-white text-3xl hover:fill-current hover:text-[#eee712]" />
              </a>
            </div>
            <div className="flex items-center">
              <a 
                ...
                rel="noopener noreferrer"
              >
                <IconWrapper icon={FaYoutube} className="text-white text-3xl hover:fill-current hover:text-[#eee712]" />
              </a>
            </div>
          </div>
        </div>
